...
* To provide an accurate formal terminology, optionally with local definitions, that may serve as standards for the global community
* To explore the utility of ontology for space data and space topics (astronomy, astronautics, etc.)
* To provide conceptual analysis and clarificaiton via the formal ontological and philosophical approach
* ...
